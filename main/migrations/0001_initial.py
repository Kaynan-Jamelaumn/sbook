    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(blank=True, choices=[('M', 'Man'), ('F', 'Female')], max_length=1, null=True)),
                ('gender', models.CharField(blank=True, choices=[('W', 'Woman'), ('M', 'Man'), ('NB', 'Non-binary'), ('O', 'Other'), ('G', 'Genderfluid'), ('A', 'Agender'), ('T', 'The Love of Your Life'), ('H', 'Heavenly Demon')], max_length=20, null=True)),
