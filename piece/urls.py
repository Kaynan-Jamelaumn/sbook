...
from .views import (
     ...
     PageView,
     PieceAnnotationView,
     PieceAnnotationContentView,
     PieceAnnotationByUserView,
     PieceAnnotationContentAndUserView,
     PieceStatusView,
     StatusByPieceView,
     StatusByUserView,
...
urlpatterns = [
     ...
     path('annotation/', PieceAnnotationView.as_view(),
          name='piece-annotation-list'),
     path('annotation/<str:pk>/', PieceAnnotationView.as_view(),
          name='piece-annotation-detail'),
     path('annotation/content/', PieceAnnotationContentView.as_view(),
          name='piece-annotation-content-list'),
     path('annotation/user/', PieceAnnotationByUserView.as_view(),
          name='piece-annotation-by-user-list'),
     path('annotation/user/<str:user>/', PieceAnnotationByUserView.as_view(),
          name='piece-annotation-by-user-detail'),
     path('annotation/content-and-user/', PieceAnnotationContentAndUserView.as_view(),
          name='piece-annotation-content-and-user-list'),
     path('annotation/user/piece/<str:user>/<str:piece>/', AnnotationByPieceAndUserView.as_view(),
         name='piece-annotation-search-by-user-and-piece-list'),
]
